...
set_property -dict { PACKAGE_PIN H5   IOSTANDARD LVCMOS33   SLEW FAST} [get_ports { digit[0] }]; # 7_SEG1_EN
set_property -dict { PACKAGE_PIN H4   IOSTANDARD LVCMOS33   SLEW FAST} [get_ports { digit[1] }]; # 7_SEG2_EN
set_property -dict { PACKAGE_PIN J4   IOSTANDARD LVCMOS33   SLEW FAST} [get_ports { digit[2] }]; # 7_SEG3_EN
set_property -dict { PACKAGE_PIN J3   IOSTANDARD LVCMOS33   SLEW FAST} [get_ports { digit[3] }]; # 7_SEG4_EN